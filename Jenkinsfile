...
//
// https://github.com/KhulnaSoft/Templates/blob/master/Jenkinsfile
...
pipeline {
  ...
  stages {
    stage ('Checkout') {
      steps {
        checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '', url: 'https://github.com/KhulnaSoft/DevX/tree/master/HAProxy-configs']]])
      }
    }
