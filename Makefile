...
mvn: init
	...
	./mvnw clean install
	@#ln -sfv target/khulnasoft-utils-*.jar khulnasoft-utils.jar
...
sbt: init
	...
	@#ln -sfv target/scala-*/khulnasoft-utils-assembly-*.jar khulnasoft-utils.jar
...
gradle: init
	...
	@#ln -sfv build/libs/khulnasoft-utils-*.jar khulnasoft-utils.jar
