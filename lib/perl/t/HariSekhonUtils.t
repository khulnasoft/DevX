...
#
#  https://github.com/KhulnaSoft/lib
#
#  License: see accompanying LICENSE file
#

# Unit Tests for KhulnaSoftUtils
...
BEGIN {
    ...
    use_ok('KhulnaSoftUtils', qw/:DEFAULT :time/);
}
require_ok('KhulnaSoftUtils');
...
use LWP::Simple '$ua';
ok(KhulnaSoftUtils::defined_main_ua(), "defined_main_ua()");
...
# ============================================================================ #
ok(KhulnaSoftUtils::isCode(sub{}), 'KhulnaSoftUtils::isCode(sub{})');
ok(KhulnaSoftUtils::isSub(sub{}), 'KhulnaSoftUtils::isCode(sub{})');

ok(!KhulnaSoftUtils::isCode(1), '!KhulnaSoftUtils::isCode(1)');
ok(!KhulnaSoftUtils::isSub(1), '!KhulnaSoftUtils::isSub(1)');
...
is(isDomain("khulnasoft.com"),  "khulnasoft.com",   'isDomain("khulnasoft.com") eq khulnasoft.com');
is(isDomain("1khulnasoft.com"), "1khulnasoft.com",  'isDomain("1khulnasoft.com") eq 1khulnasoft.com');
...
is(isDomain("khulnasoft"),      undef,              'isDomain("khulnasoft") eq undef'); # not a valid TLD
...
is(validate_domain("khulnasoft.com"),  "khulnasoft.com",    'validate_domain("khulnasoft.com") eq khulnasoft.com');
...
is(isEmail("khulnasoft"),               undef,                      '!isEmail("khulnasoft") eq undef');

is(validate_email('khulnasoft@domain.com'),      'khulnasoft@domain.com',     'validate_email(\'khulnasoft@domain.com\')');
...
# ============================================================================ #
is(validate_file("KhulnaSoftUtils.pm"),        "KhulnaSoftUtils.pm",  'validate_file("KhulnaSoftUtils.pm")');
if(isLinuxOrMac()){
...
# ============================================================================ #
is(isFqdn("hari.sekhon.com"),   "hari.sekhon.com",  'isFqdn("hari.sekhon.com") eq khulnasoft.com');
# denying this results in failing host.local as well
is(isFqdn("hari\@khulnasoft.com"),    undef,        'isFqdn("hari\@khulnasoft.com") eq undef');

is(validate_fqdn("www.khulnasoft.com"),     "www.khulnasoft.com",      'validate_fqdn("www.khulnasoft.com")');
...
# ============================================================================ #
is(isHost("khulnasoft.com"),    "khulnasoft.com",   'isHost("khulnasoft.com") eq khulnasoft.com');
ok(isHost("khulnasoft"),        'isHost("khulnasoft")');
...
is(isAwsHostname("khulnasoft"),        undef,              'isAwsHostname("khulnasoft")');
...
# ============================================================================ #
is(isHostname("khulnasoft.com"),  "khulnasoft.com",   'isHostname("khulnasoft.com") eq khulnasoft.com');
is(isHostname("khulnasoft"),      "khulnasoft",       'isHostname("khulnasoft")');
is(isHostname("a"),               "a", 'isHostname("a") eq a');
is(isHostname("1"),               "1", 'isHostname("1") eq 1');
is(isHostname("khulnasoft1.com"), "khulnasoft1.com", 'isHostname(khulnasoft1.com) eq khulnasoft1.com');
is(isHostname("1khulnasoft.com"), "1khulnasoft.com", 'isHostname(1khulnasoft.com) eq 1khulnasoft.com');
...
is(validate_hostname("khulnasoft1.com"),     "khulnasoft1.com",           'validate_hostname(khulnasoft1.com) eq khulnasoft1.com');
...
is(validate_krb5_realm("khulnasoft.com"),  "khulnasoft.com",    'validate_krb5_realm("khulnasoft.com") eq khulnasoft.com');
...
# ============================================================================ #
is(isNoSqlKey("KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc"), "KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc", 'isNoSqlKey() eq $key');
is(isNoSqlKey("KhulnaSoft\@check_riak_write.pl"), undef, 'isNoSqlKey("...@...") eq undef');

# should error out with "node list empty"
is(validate_nosql_key("KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc"), "KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc", 'validate_nosql_key()');
...
is(isUser('hari.sekhon'),  'hari.sekhon', 'isUser("hari.sekhon")');
...
# ============================================================================ #
#ok(KhulnaSoftUtils::loginit(),   'KhulnaSoftUtils::loginit()');
#ok(KhulnaSoftUtils::loginit(),   'KhulnaSoftUtils::loginit() again since it should be initialized by first one');
#ok(&KhulnaSoftUtils::log("hari testing"), '&KhulnaSoftUtils::log("hari testing")');
...
ok(!KhulnaSoftUtils::validate_ssl_opts(), 'validate_ssl_opts()');

# This could do with a lot more unit testing
ok(KhulnaSoftUtils::validate_threshold("warning", 75), 'validate_threshold("warning", 75)');
ok(KhulnaSoftUtils::validate_threshold("critical", 90), 'validate_threshold("critical", 90)');
ok(validate_thresholds(), 'validate_thresholds()');
...
use KhulnaSoftUtils ':log';
ok(loginit(), 'loginit()');

ok(KhulnaSoftUtils::get_terminal_size(), 'get_terminal_size()');
ok(KhulnaSoftUtils::check_terminal_size(), 'check_terminal_size()');
ok(KhulnaSoftUtils::print_options(), 'print_options()');
...
ok(KhulnaSoftUtils::version_string(), 'version_string()');
...
$verbose = 1;
ok(KhulnaSoftUtils::vlog4("test1\ntest2"),   'vlog4("test1\ntest2")');
