...
try:
    ...
    from khulnasoft.utils import log, log_option, CriticalError, UnknownError
    from khulnasoft.utils import validate_chars, validate_file, prog
        ...
        try:
            if self.base_url:
                ...
                client = docker.DockerClient(base_url=self.base_url,
                                             ...
                                             tls=self.tls_config,
                                             user_agent='KhulnaSoft Ltd {}'.format(prog)
                                            )
            else:
