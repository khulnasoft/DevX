...
from khulnasoft.utils import qquit, log, CodingError, CriticalError, UnknownError
from khulnasoft.utils import validate_host, validate_port, validate_float, get_topfile, random_alnum
...
class PubSubNagiosPlugin(NagiosPlugin):
    ...
    def __init__(self):
        ...
        self.publish_message = "Test message from KhulnaSoft Ltd {0} on host {1} "\
