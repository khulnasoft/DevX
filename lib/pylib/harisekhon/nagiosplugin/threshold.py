...
from khulnasoft.utils import InvalidOptionException, CodingError, isBool, isInt, isFloat, log
...
class Threshold(object):
    """
    KhulnaSoft.NagiosPlugin.Threshold class for KhulnaSoft.NagiosPlugin inherited classes to utilize
    """
