...
try:
    ...
    from khulnasoft.utils import log, CriticalError, prog, prog_version, code_error
...
class RequestHandler(object):
    ...
    def req(self, method, url, *args, **kwargs):
        ...
        req = None
        user_agent = 'KhulnaSoft Ltd {prog} version {version}'.format(prog=prog, version=prog_version)
