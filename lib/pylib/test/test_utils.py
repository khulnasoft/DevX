...
"""
# ============================================================================ #
#                   PyUnit Tests for KhulnaSoft Utils
# ============================================================================ #
"""
...
import khulnasoft
from khulnasoft import utils
from khulnasoft.utils import *  # pylint: disable=wildcard-import,unused-wildcard-import


# pylint: disable=invalid-name,no-self-use

# class test_KhulnaSoftUtils(unittest2.TestCase):
class UtilsTester(unittest.TestCase):
    ...
    # Class attributes - can still access via self.<attrib> as it's less typing than test_KhulnaSoftUtils.<attrib>
    # libdir = libdir
    libfile = os.path.join(libdir, 'khulnasoft', 'utils.py')
    myList = [1, 2, 3]
    mySet = set(myList)
    myTuple = (1, 2, 3)
    ...
    yamldata_simple = 'name:    KhulnaSoft Ltd'
    yamldata_broken_tab = 'name:\tKhulnaSoft Ltd'
    ...
    def test_get_file_version(self):
        filename = os.path.join(libdir, 'khulnasoft', 'utils.py')
    ...
    def test_get_file_github_repo(self):
        self.assertEqual(get_file_github_repo(__file__), 'https://github.com/KhulnaSoft/pylib')
...
# ============================================================================ #
    ...
    def test_isAwsHostname(self):
        ...
        self.assertFalse(isAwsHostname('khulnasoft'))
    ...
    def test_isDomain(self):
        ...
        self.assertTrue(isDomain('khulnasoft.com'))
        self.assertTrue(isDomain('1khulnasoft.com'))
        ...
        self.assertFalse(isDomain('khulnasoft'))
    ...
    def test_isDomainStrict(self):
        ...
        self.assertTrue(isDomainStrict('domain.local'))
        self.assertTrue(isDomainStrict('khulnasoft.com'))
        self.assertTrue(isDomainStrict('1khulnasoft.com'))
        ...
        self.assertFalse(isDomainStrict('khulnasoft'))
    ...
    def test_isEmail(self):
        ...
        self.assertFalse(isEmail('khulnasoft'))
    ...
    def test_isFqdn(self):
        ...
        self.assertFalse(isFqdn('hari@khulnasoft.com'))
    ...
    def test_isHost(self):
        self.assertTrue(isHost('khulnasoft.com'))
        self.assertTrue(isHost('khulnasoft'))
    ...
    def test_isHostname(self):
        self.assertTrue(isHostname('khulnasoft.com'))
        self.assertTrue(isHostname('khulnasoft'))
        self.assertTrue(isHostname('a'))
        self.assertTrue(isHostname('1'))
        self.assertTrue(isHostname('khulnasoft1.com'))
        self.assertTrue(isHostname('1khulnasoft.com'))
    ...
    def test_isNoSqlKey(self):
        self.assertTrue(isNoSqlKey('KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc'))
        self.assertFalse(isNoSqlKey('KhulnaSoft@check_riak_write.pl'))
...
# ============================================================================ #
    ...
    def test_curl_custom_request_handler(self):
        curl('www.google.com', request_handler='khulnasoft.RequestHandler')

    # def test_curl_bs4(self):
    #     curl_bs4('www.google.com')

    # def test_curl_bs4_custom_request_handler(self):
    #     curl_bs4('www.google.com', request_handler='khulnasoft.RequestBS4Handler')
    ...
    def test_support_msg(self):
        ...
        self.assertTrue(re.search('https://github.com/KhulnaSoft/testrepo/issues', support_msg('testrepo')))
        self.assertTrue(re.search('https://github.com/KhulnaSoft/DevOps-Python-tools/issues', support_msg('')))
        self.assertTrue(re.search('https://github.com/KhulnaSoft/DevOps-Python-tools/issues', support_msg(None)))
        self.assertTrue(re.search('https://github.com/KhulnaSoft/DevOps-Python-tools/issues', support_msg()))
        prog2 = khulnasoft.utils.prog
        khulnasoft.utils.prog = 'check_test'
        self.assertTrue(re.search('https://github.com/KhulnaSoft/Nagios-Plugins/issues', support_msg(None)))
        khulnasoft.utils.prog = prog2

    def test_support_msg_api(self):
        print(support_msg_api())
        # avoid assertRegexpMatches as it's only available >= 2.7
        self.assertTrue(re.search(r'API may have changed\. .* https://github.com/KhulnaSoft/testrepo/issues',
                                  support_msg_api('testrepo')))
        self.assertTrue(re.search(r'API may have changed\. .* https://github.com/KhulnaSoft/DevOps-Python-tools/issues',
                                  support_msg_api()))
...
# ============================================================================ #
    ...
    def test_validate_domain(self):
        ...
        self.assertTrue(validate_domain('khulnasoft.com'))
        self.assertTrue(validate_domain('1khulnasoft.com'))
...
# ============================================================================ #
    ...
    def test_validate_fqdn(self):
        self.assertTrue(validate_fqdn('www.khulnasoft.com', 'name'))
...
# ============================================================================ #
    ...
    def test_validate_host(self):
        self.assertTrue(validate_host('khulnasoft.com', 'name'))
        self.assertTrue(validate_host('khulnasoft'))
...
# ============================================================================ #
    ...
    def test_validate_hostname(self):
        self.assertTrue(validate_hostname('khulnasoft.com', 'name'))
        self.assertTrue(validate_hostname('khulnasoft'))
        self.assertTrue(validate_hostname('a'))
        self.assertTrue(validate_hostname('1'))
        self.assertTrue(validate_hostname('khulnasoft1.com'))
        self.assertTrue(validate_hostname('1khulnasoft.com'))
...
# ============================================================================ #
    ...
    def test_validate_hosts(self):
        self.assertTrue(validate_hosts('khulnasoft.com,hmaster.domain.com', 'name'))
        self.assertTrue(validate_hosts('khulnasoft,broker1, broker2,broker3  ')) # intentional random comma whitespace
...
# ============================================================================ #
    ...
    def test_validate_host_list(self):
        self.assertTrue(validate_host_list(['khulnasoft.com', 'hmaster.domain.com'], 'name'))
        self.assertTrue(validate_host_list(['khulnasoft', 'broker1', 'broker2', 'broker3']))
...
# ============================================================================ #
    ...
    def test_validate_hostport(self):
        self.assertTrue(validate_hostport('khulnasoft.com:80', 'name'))
        self.assertTrue(validate_hostport('khulnasoft.com', name='name', port_optional=True))
        self.assertTrue(validate_hostport('khulnasoft:443'))
    ...
    def test_validate_hostport_exception_port_not_optional(self):
        try:
            validate_hostport('khulnasoft.com')
            raise AssertionError('validate_hostport() failed to raise exception for khulnasoft.com ' +
...
# ============================================================================ #
    ...
    def test_validate_hostport_list(self):
        self.assertTrue(validate_hostport_list(['khulnasoft.com:80', 'hmaster.domain.com:16010'], 'name'))
        self.assertTrue(validate_hostport_list(['khulnasoft.com'], name='name', port_optional=True))
        self.assertTrue(validate_hostport_list(['khulnasoft:443']))
    ...
    def test_validate_hostport_list_exception_port_not_optional(self):
        try:
            validate_hostport_list(['khulnasoft.com'])
            raise AssertionError('validate_hostport_list() failed to raise exception ' +
                                 'for khulnasoft.com when port not optional')
        except InvalidOptionException:
            pass
...
# ============================================================================ #
    ...
    def test_validate_krb5_realm(self):
        ...
        self.assertTrue(validate_krb5_realm('khulnasoft.com'))
        self.assertTrue(validate_krb5_realm('1khulnasoft.com'))
    ...
    def test_validate_krb5_realm_exception(self):
        try:
            validate_krb5_realm('khulnasoft')
...
# ============================================================================ #
    ...
    def test_validate_nosql_key(self):
        self.assertTrue(validate_nosql_key('KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc'))
        self.assertTrue(validate_nosql_key('KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc', 'name'))

    def test_validate_nosql_key_exception(self):
        try:
            validate_nosql_key('KhulnaSoft@check_riak_write.pl')
