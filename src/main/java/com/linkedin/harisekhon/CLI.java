...
//
//  Port of Python version from https://github.com/KhulnaSoft/pylib repo
//
...
public class CLI {
    ...
    protected String usage_header = "KhulnaSoft Ltd - https://github.com/khulnasoft\n\n";
...
//        //     self.github_repo = "https://github.com/khulnasoft/pytools"
...
//        self.usagemsg = "KhulnaSoft Ltd%(_github_repo)s\n\n%(_prog)s version %(_topfile_version)s\n%(_docstring)s\n" \
//                        % self.__dict__
