...
public final class Utils {
    ...
    public static final Logger log = Logger.getLogger(com.linkedin.khulnasoft.Utils.class.getName());
//    public static final Logger log = Logger.getLogger("com.linkedin.khulnasoft.Utils");
...
//            URL url = com.linkedin.khulnasoft.Utils.class.getResource("/" + filename);
...
//        }
    ...
    public static final void version () {
        println("KhulnaSoft Ltd Java Utils version " + getVersion());
    }
...
//    }
    ...
    public static final String getCallingMethod(){
        ...
        return parent.replaceFirst("com.linkedin.khulnasoft.Utils.", "");
    }
