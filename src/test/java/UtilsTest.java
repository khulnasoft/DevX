...
/**
 * Unit tests for com.linkedin.khulnasoft.Utils
 */
public class UtilsTest { // extends TestCase { // JUnit 3
    ...
    */
    ...
    public void testUtilsInstance(){
        Utils u = new com.linkedin.khulnasoft.Utils();
...
//        URL url = com.linkedin.khulnasoft.Utils.class.getResource("/tlds-alpha-by-domain.txt");
        URL url = com.linkedin.khulnasoft.Utils.class.getResource("/");
        if(url == null){
...
//        String[] myArray_test = arraylistToArray(myList);
    ...
    */
    ...
    public void testIsAwsHostname(){
        ...
        assertFalse(isAwsHostname("khulnasoft"));
    ...
    public void testValidateAwsHostnameException() {
        validateAwsHostname("khulnasoft");
    }
    @Test(expected=IllegalArgumentException.class)
    ...
    public void testIsDomain(){
        ...
        assertTrue(isDomain("khulnasoft.com"));
        assertTrue(isDomain("1khulnasoft.com"));
        ...
        assertFalse(isDomain("khulnasoft")); // not a valid TLD
        assertFalse(isDomain(null)); // not a valid TLD
    }

    @Test
    public void testValidateDomain(){
        assertEquals("validateDomain(khulnasoft.com)", "khulnasoft.com", validateDomain("khulnasoft.com"));
    }
    ...
    public void testValidateDomainStrict(){
        assertEquals("validateDomainStrict(khulnasoft.com)", "khulnasoft.com", validateDomainStrict("khulnasoft.com"));
    }
    ...
    public void testIsEmail(){
        ...
        assertFalse(isEmail("khulnasoft"));
    ...
    public void testIsFqdn(){
        ...
        assertFalse(isFqdn("hari@khulnasoft.com"));
        assertFalse(isFqdn(null));
    }

    @Test
    public void testValidateFqdn(){
        assertEquals("validateFqdn(www.khulnasoft.com)", "www.khulnasoft.com", validateFqdn("www.khulnasoft.com"));
    ...
    public void testValidateFqdnException() {
        validateFqdn("hari@khulnasoft.com");
    }
    ...
    public void testIsHost(){
        assertTrue(isHost("khulnasoft.com"));
        assertTrue(isHost("khulnasoft"));
    ...
    */
    ...
    public void testIsHostname(){
        assertTrue(isHostname("khulnasoft.com"));
        assertTrue(isHostname("khulnasoft"));
        assertTrue(isHostname("a"));
        assertTrue(isHostname("khulnasoft1.com"));
        assertTrue(isHostname("1"));
        assertTrue(isHostname("1khulnasoft.com"));
    ...
    public void testValidateHostname(){
        ...
        assertEquals("validateHostname(khulnasoft1.com)",  "khulnasoft1.com",  validateHostname("khulnasoft1.com"));
    ...
    public void testValidateKrb5Realm(){
        assertEquals("validateKrb5Realm(khulnasoft.com)", "khulnasoft.com", validateKrb5Realm("khulnasoft.com"));
    }
    ...
    public void testIsNoSqlKey(){
        assertTrue(isNoSqlKey("KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc"));
        assertFalse(isNoSqlKey("KhulnaSoft@check_riak_write.pl"));
        assertFalse(isNoSqlKey(null));
    }

    @Test
    public void testValidateNosqlKey(){
        assertEquals("validateNoSqlKey(KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc)", "KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc", validateNoSqlKey("KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc"));
        assertEquals("validateNoSqlKey(KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc, name)", "KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc", validateNoSqlKey("KhulnaSoft:check_riak_write.pl:riak1:1385226607.02182:20abc", "name"));
    }

    @Test(expected=IllegalArgumentException.class)
    public void testValidateNosqlKeyException() {
        validateNoSqlKey("KhulnaSoft@check_riak_write.pl");
    }
