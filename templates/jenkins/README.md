...
[![Lines of Code](https://img.shields.io/badge/lines%20of%20code-10k-lightgrey?logo=codecademy)](https://github.com/KhulnaSoft/Jenkins)
[![License](https://img.shields.io/github/license/KhulnaSoft/Jenkins)](https://github.com/KhulnaSoft/Jenkins/blob/master/LICENSE)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/KhulnaSoft/Jenkins?logo=github)](https://github.com/KhulnaSoft/Jenkins/commits/master)

[![Codacy Badge](https://app.codacy.com/project/badge/Grade/48126b1db0ed4471a9888012b1ccab73)](https://app.codacy.com/gh/KhulnaSoft/Jenkins/dashboard)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Jenkins&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_Jenkins)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Jenkins&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_Jenkins)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Jenkins&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_Jenkins)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Jenkins&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_Jenkins)
...
[![Repo on GitHub](https://img.shields.io/badge/repo-GitHub-2088FF?logo=github)](https://github.com/KhulnaSoft/Jenkins)
[![Repo on GitLab](https://img.shields.io/badge/repo-GitLab-FCA121?logo=gitlab)](https://gitlab.com/KhulnaSoft/Jenkins)
[![Repo on Azure DevOps](https://img.shields.io/badge/repo-Azure%20DevOps-0078D7?logo=azure%20devops)](https://dev.azure.com/khulnasoft/GitHub/_git/Jenkins)
[![Repo on BitBucket](https://img.shields.io/badge/repo-BitBucket-0052CC?logo=bitbucket)](https://bitbucket.org/KhulnaSoft/Jenkins)

[![Jenkinsfile](https://github.com/KhulnaSoft/Jenkins/actions/workflows/jenkinsfile.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/jenkinsfile.yaml)
[![Groovy](https://github.com/KhulnaSoft/Jenkins/actions/workflows/groovyc.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/groovyc.yaml)
[![YAML](https://github.com/KhulnaSoft/Jenkins/actions/workflows/yaml.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/yaml.yaml)
[![Markdown](https://github.com/KhulnaSoft/Jenkins/actions/workflows/markdown.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/markdown.yaml)
[![Validation](https://github.com/KhulnaSoft/Jenkins/actions/workflows/validate.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/validate.yaml)
[![Grype](https://github.com/KhulnaSoft/Jenkins/actions/workflows/grype.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/grype.yaml)
[![Kics](https://github.com/KhulnaSoft/Jenkins/actions/workflows/kics.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/kics.yaml)
[![Semgrep](https://github.com/KhulnaSoft/Jenkins/actions/workflows/semgrep.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/semgrep.yaml)
[![Semgrep Cloud](https://github.com/KhulnaSoft/Jenkins/actions/workflows/semgrep-cloud.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/semgrep-cloud.yaml)
[![SonarCloud](https://github.com/KhulnaSoft/Jenkins/actions/workflows/sonarcloud.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/sonarcloud.yaml)
[![Trivy](https://github.com/KhulnaSoft/Jenkins/actions/workflows/trivy.yaml/badge.svg)](https://github.com/KhulnaSoft/Jenkins/actions/workflows/trivy.yaml)

Advanced Jenkinsfile & Jenkins Shared Library.

- [Jenkinsfile](https://github.com/KhulnaSoft/Jenkins/blob/master/Jenkinsfile) - epic Jenkinsfile template - full of real-world tricks from Production
- [vars/](https://github.com/KhulnaSoft/Jenkins/tree/master/vars) - Groovy Shared Library reusable functions - used in Production for years

Additional Jenkins scripts are available in my [KhulnaSoft/DevOps-Bash-tools](https://github.com/KhulnaSoft/DevOps-Bash-tools) repo for Jenkins Rest API and Jenkins Groovy scripts for the Admin Script Console, and Jenkins-on-Kubernetes in my [KhulnaSoft/Kubernetes-configs](https://github.com/KhulnaSoft/Kubernetes-configs) repo.
...
@Library('github.com/khulnasoft/jenkins@master') _
...
Builds Docker images and deploys them to [Kubernetes](https://github.com/KhulnaSoft/Kubernetes-configs) via [ArgoCD](https://github.com/KhulnaSoft/Kubernetes-configs/tree/master/argocd/base). Optionally scans the repo code, built container images, and purges Cloudflare Cache.
...
![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/gcp_cloudbuild_deployed_after_container_scans_failed.png)

See [gcpDeployKubernetesPipeline.groovy](https://github.com/KhulnaSoft/Jenkins/blob/master/vars/gcpDeployKubernetesPipeline.groovy) for more details, options etc.
...
![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/terraform_applied_but_failed_fmt_check.png)

Plan found no changes so skipped Apply or asking for Approval:

![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/terraform_plan_no_changes.png)

Plan found changes but Approval was not authorized, so Apply did not proceed:

![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/terraform_not_approved.png)
...
![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/jenkinsfile_update_library_tag_update_jenkinsfile.png)
...
![](https://github.com/KhulnaSoft/Diagrams-as-Code/blob/master/screenshots/jenkins_job_config_backups.png)

## More Documentation

Read the comments at the top of each library function under [vars/](https://github.com/KhulnaSoft/Jenkins/tree/master/vars)`<function>.groovy` for more details.
...
![](https://raw.githubusercontent.com/KhulnaSoft/Diagrams-as-Code/master/images/jenkins_kubernetes_cicd.svg)
...
Import the library as shown above directly from this repo, replacing `@master` with `@<hashref>` to fix to an immutable version (tags are not immutable). This is a GitHub security best practice for CI/CD as seen in this [doc](https://docs.github.com/en/actions/security-guides/security-hardening-for-devx-actions#using-third-party-actions).

### Option 2 - Public Fork (fully automated)

Fork this repo for more control and visibility over all updates.

Enable the [fork-sync](https://github.com/KhulnaSoft/Jenkins/blob/master/.github/workflows/fork-sync.yaml) github actions workflow in your fork to keep the master branch sync'd every few hours.

You can then create tags or environment branches to stage updates across dev/staging/production.

If using environment branches, enable the [fork-update-pr](https://github.com/KhulnaSoft/Jenkins/blob/master/.github/workflows/fork-update-pr.yaml) github actions workflow to automatically raise GitHub Pull Requests for your environment branches to audit, authorize & control updates.

### Option 3 - Private Copy (semi-automated)

Download the functions you want into your private jenkins shared library repo.

You can use the [vars/download.sh](https://github.com/KhulnaSoft/Jenkins/blob/master/vars/download.sh) script to help you download given `*.groovy` files and periodically run it to get updates to these previously downloaded functions.

You will be responsible for committing and reconciling any divergences in your local copies.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=KhulnaSoft/Jenkins&type=Date)](https://star-history.com/#KhulnaSoft/Jenkins&Date)
