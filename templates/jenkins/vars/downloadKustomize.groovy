...
//
// This is better (easier and more version flexible across different pipelines) than maintaining a docker image khulnasoft/git-kustomize docker image.
...
// Kustomize version needs to be fairly recent to solve 'unknown field "includeCRDs"' when combining Kustomize + Helm with includeCRDs option as seen in *-kustomization.yaml in https://github.com/KhulnaSoft/Kubernetes-configs
