...
def call (Map args = [:]) {
  ...
  //
  // git@github.com:KhulnaSoft/Kubernetes -> KhulnaSoft/Kubernetes
  String ownerRepo = args.repo.split(':')[-1]
  //
  // https://github.com/KhulnaSoft/Kubernetes -> KhulnaSoft/Kubernetes
  ownerRepo = ownerRepo.split('/')[-2, -1].join('/')
  //
  // KhulnaSoft/Kubernetes.git -> KhulnaSoft/Kubernetes
