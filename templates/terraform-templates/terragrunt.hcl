...
terraform {
  ...
  #
  source = "github.com:KhulnaSoft/Terraform.git//app?ref=v0.0.1"
  #
  # Registry Sources
  #
  ...
  extra_arguments "retry_lock" {
    ...
    arguments = [
      ...
      #
      #     https://github.com/KhulnaSoft/Jenkins/blob/master/vars/terraformPipeline.groovy
      #        OR
      #     https://github.com/KhulnaSoft/Jenkins/blob/master/vars/terragruntPipeline.groovy
      #
    ]
  }
