...
[![Contributors](https://img.shields.io/github/contributors/KhulnaSoft/Nagios-Plugins?logo=github)](https://github.com/KhulnaSoft/Nagios-Plugins/graphs/contributors)
[![Lines of Code](https://img.shields.io/badge/lines%20of%20code-80k-lightgrey?logo=codecademy)](https://github.com/KhulnaSoft/Nagios-Plugins)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/KhulnaSoft/Nagios-Plugins?logo=github)](https://github.com/KhulnaSoft/Nagios-Plugins/commits/master)

[![Codacy](https://app.codacy.com/project/badge/Grade/22d2175b89d8414d921d0196984307bd)](https://www.codacy.com/gh/KhulnaSoft/Nagios-Plugins/dashboard)
[![CodeFactor](https://www.codefactor.io/repository/github/khulnasoft/Nagios-Plugins/badge)](https://www.codefactor.io/repository/github/khulnasoft/Nagios-Plugins)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=alert_status)](https://sonarcloud.io/dashboard?id=KhulnaSoft_Nagios-Plugins)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=sqale_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_Nagios-Plugins)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=reliability_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_Nagios-Plugins)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=security_rating)](https://sonarcloud.io/dashboard?id=KhulnaSoft_Nagios-Plugins)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=KhulnaSoft_Nagios-Plugins)

<!-- only counts Python lines of code, underestimates by at least half
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=KhulnaSoft_Nagios-Plugins&metric=ncloc)](https://sonarcloud.io/dashboard?id=KhulnaSoft_Nagios-Plugins)
-->
<!-- site broken
[![Python 3](https://pyup.io/repos/github/KhulnaSoft/Nagios-Plugins/python-3-shield.svg)](https://pyup.io/repos/github/KhulnaSoft/Nagios-Plugins/)
[![PyUp](https://pyup.io/repos/github/KhulnaSoft/Nagios-Plugins/shield.svg)](https://pyup.io/account/repos/github/KhulnaSoft/Nagios-Plugins/)
-->

[![Linux](https://img.shields.io/badge/OS-Linux-blue?logo=linux)](https://github.com/KhulnaSoft/Nagios-Plugins)
[![Mac](https://img.shields.io/badge/OS-Mac-blue?logo=apple)](https://github.com/KhulnaSoft/Nagios-Plugins)
[![Docker](https://img.shields.io/badge/container-Docker-blue?logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/nagios-plugins/)
[![Dockerfile](https://img.shields.io/badge/repo-Dockerfiles-blue?logo=docker&logoColor=white)](https://github.com/KhulnaSoft/Dockerfiles)
[![DockerHub Pulls](https://img.shields.io/docker/pulls/khulnasoft/nagios-plugins?label=DockerHub%20pulls&logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/nagios-plugins)
[![DockerHub Build Automated](https://img.shields.io/docker/automated/khulnasoft/nagios-plugins?logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/nagios-plugins/)
...
<!--
[![Docker Build Status](https://img.shields.io/docker/build/khulnasoft/nagios-plugins?logo=docker&logoColor=white)](https://hub.docker.com/r/khulnasoft/nagios-plugins/builds)
[![MicroBadger](https://images.microbadger.com/badges/image/khulnasoft/nagios-plugins.svg)](http://microbadger.com/#/images/khulnasoft/nagios-plugins)
-->
...
[![Jenkins](https://img.shields.io/badge/Jenkins-ready-blue?logo=jenkins&logoColor=white)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/Jenkinsfile)
[![Concourse](https://img.shields.io/badge/Concourse-ready-blue?logo=concourse)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/cicd/.concourse.yml)
[![GoCD](https://img.shields.io/badge/GoCD-ready-blue?logo=go)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/cicd/.gocd.yml)
[![TeamCity](https://img.shields.io/badge/TeamCity-ready-blue?logo=teamcity)](https://github.com/KhulnaSoft/TeamCity-CI)

[![CircleCI](https://circleci.com/gh/KhulnaSoft/Nagios-Plugins.svg?style=svg)](https://circleci.com/gh/KhulnaSoft/Nagios-Plugins)
...
[![AppVeyor](https://img.shields.io/appveyor/build/khulnasoft/Nagios-Plugins/master?logo=appveyor&label=AppVeyor)](https://ci.appveyor.com/project/KhulnaSoft/Nagios-Plugins/branch/master)
[![Drone](https://img.shields.io/drone/build/KhulnaSoft/Nagios-Plugins/master?logo=drone&label=Drone)](https://cloud.drone.io/KhulnaSoft/Nagios-Plugins)
[![Codefresh](https://g.codefresh.io/api/badges/pipeline/khulnasoft/GitHub%2FNagios%20Plugins?branch=master&key=eyJhbGciOiJIUzI1NiJ9.NWU1MmM5OGNiM2FiOWUzM2Y3ZDZmYjM3.O69674cW7vYom3v5JOGKXDbYgCVIJU9EWhXUMHl3zwA&type=cf-1)](https://g.codefresh.io/pipelines/edit/new/builds?id=5e58e344353f5db981385bf4&pipeline=Nagios%20Plugins&projects=GitHub&projectId=5e52ca8ea284e00f882ea992&context=github&filter=page:1;pageSize:10;timeFrameStart:week)
[![Cirrus CI](https://img.shields.io/cirrus/github/KhulnaSoft/Nagios-Plugins/master?logo=Cirrus%20CI&label=Cirrus%20CI)](https://cirrus-ci.com/github/KhulnaSoft/Nagios-Plugins)
[![Semaphore](https://khulnasoft.semaphoreci.com/badges/Nagios-Plugins.svg)](https://khulnasoft.semaphoreci.com/projects/Nagios-Plugins)
[![Buddy](https://img.shields.io/badge/Buddy-ready-1A86FD?logo=buddy)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/buddy.yml)
[![Shippable](https://img.shields.io/badge/Shippable-legacy-lightgrey?logo=jfrog&label=Shippable)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/shippable.yml)
[![Travis CI](https://img.shields.io/badge/TravisCI-ready-blue?logo=travis&label=Travis%20CI)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/.travis.yml)

[![Azure DevOps Pipeline](https://dev.azure.com/khulnasoft/GitHub/_apis/build/status/KhulnaSoft.Nagios-Plugins?branchName=master)](https://dev.azure.com/khulnasoft/GitHub/_build/latest?definitionId=9&branchName=master)
[![GitLab Pipeline](https://img.shields.io/badge/GitLab%20CI-legacy-lightgrey?logo=gitlab)](https://gitlab.com/KhulnaSoft/Nagios-Plugins/pipelines)
[![BitBucket Pipeline](https://img.shields.io/badge/Bitbucket%20CI-legacy-lightgrey?logo=bitbucket)](https://bitbucket.org/khulnasoft/Nagios-Plugins/addon/pipelines/home#!/)
[![AWS CodeBuild](https://img.shields.io/badge/AWS%20CodeBuild-ready-blue?logo=amazon%20aws)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/cicd/buildspec.yml)
[![GCP Cloud Build](https://img.shields.io/badge/GCP%20Cloud%20Build-ready-blue?logo=google%20cloud&logoColor=white)](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/cicd/cloudbuild.yaml)

[![Repo on GitHub](https://img.shields.io/badge/repo-GitHub-2088FF?logo=github)](https://github.com/KhulnaSoft/Nagios-Plugins)
[![Repo on GitLab](https://img.shields.io/badge/repo-GitLab-FCA121?logo=gitlab)](https://gitlab.com/KhulnaSoft/Nagios-Plugins)
[![Repo on Azure DevOps](https://img.shields.io/badge/repo-Azure%20DevOps-0078D7?logo=azure%20devops)](https://dev.azure.com/khulnasoft/GitHub/_git/Nagios-Plugins)
[![Repo on BitBucket](https://img.shields.io/badge/repo-BitBucket-0052CC?logo=bitbucket)](https://bitbucket.org/KhulnaSoft/Nagios-Plugins)

[![ShellCheck](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/shellcheck.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/shellcheck.yaml)
[![JSON](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/json.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/json.yaml)
[![YAML](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/yaml.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/yaml.yaml)
[![XML](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/xml.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/xml.yaml)
[![Validation](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/validate.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/validate.yaml)
[![Kics](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/kics.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/kics.yaml)
[![Grype](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/grype.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/grype.yaml)
[![Semgrep](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/semgrep.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/semgrep.yaml)
[![Semgrep Cloud](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/semgrep-cloud.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/semgrep-cloud.yaml)
[![Trivy](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/trivy.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/trivy.yaml)

[![Docker Build (Alpine)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_alpine.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_alpine.yaml)
[![Docker Build (Debian)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_debian.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_debian.yaml)
[![Docker Build (Fedora)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_fedora.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_fedora.yaml)
[![Docker Build (Ubuntu)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_ubuntu.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/docker_nagios_plugins_ubuntu.yaml)

[![GitHub Actions Ubuntu](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/GitHub%20Actions%20Ubuntu/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22GitHub+Actions+Ubuntu%22)
[![Mac](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac.yaml)
[![Mac 11](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac_11.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac_11.yaml)
[![Mac 12](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac_12.yaml/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions/workflows/mac_12.yaml)
[![Ubuntu](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Ubuntu/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Ubuntu%22)
[![Ubuntu 20.04](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Ubuntu%2020.04/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Ubuntu+20.04%22)
[![Ubuntu 22.04](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Ubuntu%2022.04/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Ubuntu+22.04%22)
[![Debian](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Debian/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Debian%22)
[![Debian 10](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Debian%2010/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Debian+10%22)
[![Debian 11](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Debian%2011/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Debian+11%22)
[![Debian 12](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Debian%2012/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Debian+12%22)
[![Fedora](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Fedora/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Fedora%22)
[![Alpine](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Alpine/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Alpine%22)
[![Alpine 3](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Alpine%203/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Alpine+3%22)

[![Python versions](https://img.shields.io/badge/Python-2.7+-3776AB?logo=python&logoColor=white)](https://github.com/KhulnaSoft/Nagios-Plugins)
[![Python 3.7](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Python%203.7/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Python+3.7%22)
[![Python 3.8](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Python%203.8/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Python+3.8%22)
[![Python 3.9](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Python%203.9/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Python+3.9%22)
[![Python 3.10](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Python%203.10/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Python+3.10%22)
[![Python 3.11](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Python%203.11/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Python+3.11%22)

[![Perl versions](https://img.shields.io/badge/Perl-5.10+-39457E?logo=perl)](https://github.com/KhulnaSoft/Nagios-Plugins)
[![Perl](https://github.com/KhulnaSoft/Nagios-Plugins/workflows/Perl/badge.svg)](https://github.com/KhulnaSoft/Nagios-Plugins/actions?query=workflow%3A%22Perl%22)
...
Supports a a wide variety of [compatible Enterprise Monitoring systems](https://github.com/KhulnaSoft/Nagios-Plugins#enterprise-monitoring-systems).
...
Also useful to be run on the command line for testing or in scripts for dependency availability checking, and comes with a selection of [advanced HAProxy configurations](https://github.com/KhulnaSoft/DevX/tree/master/HAProxy-configs) for these technologies to make monitoring and scripting easier for clustered technologies.

Fix requests, suggestions, updates and improvements are most welcome via Github [issues](https://github.com/KhulnaSoft/Nagios-Plugins/issues) or [pull requests](https://github.com/KhulnaSoft/Nagios-Plugins/pulls) (in which case GitHub will give you credit and mark you as a contributor to the project :) ).
...
1. Git clone this repo and compile dependencies by running `make`<br>
      OR<br>
1. Download pre-built self-contained [Docker image](https://hub.docker.com/r/khulnasoft/nagios-plugins/)

Execute each program on the command line with `--help` to see its options.

### Ready-to-run Docker Image

All plugins and their pre-compiled dependencies can be found ready-to-run on [DockerHub](https://hub.docker.com/r/khulnasoft/nagios-plugins/), if you have [Docker](https://www.docker.com/) installed, fetch this project like so:

```shell
docker pull khulnasoft/nagios-plugins
```
...
git clone https://github.com/KhulnaSoft/Nagios-Plugins
...
Make sure to read [Detailed Build Instructions](https://github.com/KhulnaSoft/Nagios-Plugins#detailed-build-instructions) further down for more information.
...
- [Hadoop Ecosystem](https://github.com/KhulnaSoft/Nagios-Plugins#hadoop-ecosystem) - HDFS, Yarn, HBase, Ambari, Atlas, Ranger
  - [Hadoop Distributions](https://github.com/KhulnaSoft/Nagios-Plugins#hadoop-distributions) - Cloudera, Hortonworks, MapR, IBM BigInsights
  - [SQL-on-Hadoop](https://github.com/KhulnaSoft/Nagios-Plugins#sql-on-hadoop) - Hive, Drill, Presto
- [Service Discovery & Coordination](https://github.com/KhulnaSoft/Nagios-Plugins#service-discovery--coordination) - ZooKeeper, Consul, Vault
- [Cloud](https://github.com/KhulnaSoft/Nagios-Plugins#cloud) - AWS
- [Docker / Containerization](https://github.com/KhulnaSoft/Nagios-Plugins#docker--containerization) - Docker & Docker Swarm, Mesos, Kubernetes
- [Search](https://github.com/KhulnaSoft/Nagios-Plugins#search) - Elasticsearch, Solr / SolrCloud
- [NoSQL](https://github.com/KhulnaSoft/Nagios-Plugins#nosql) - Cassandra, Redis, Riak, Memcached, CouchDB
- [SQL Databases](https://github.com/KhulnaSoft/Nagios-Plugins#sql-databases) - MySQL
- [Pub-Sub / Message Queues](https://github.com/KhulnaSoft/Nagios-Plugins#publish---subscribe--message-queues) - Kafka, Redis, RabbitMQ
- [CI - Continuous Integration & Build Systems](https://github.com/KhulnaSoft/Nagios-Plugins#ci---continuous-integration--build-systems---git-jenkins-travis-ci--dockerhub-automated-builds) - Jenkins, Travis CI, GoCD, DockerHub, Git
- [Infrastructure](https://github.com/KhulnaSoft/Nagios-Plugins#infrastructure---internet---web-dns-ssl-domains)
  - [Internet](https://github.com/KhulnaSoft/Nagios-Plugins#infrastructure---internet---web-dns-ssl-domains) - Web, DNS, SSL & Domain Expiry
  - [Linux](https://github.com/KhulnaSoft/Nagios-Plugins#infrastructure---linux---os-network-puppet-raid-ssh-clusters-yum-security-updates) - OS, Network, Puppet, RAID, SSH, Clusters, Yum Security Updates
...
- [Hortonworks](https://hortonworks.com/) - the standard modern Hadoop distribution - see `check_ambari_*.pl` in the [Hadoop Ecosystem](https://github.com/KhulnaSoft/Nagios-Plugins#hadoop-ecosystem) section above
...
If running docker checks from within the [nagios plugins docker image](https://hub.docker.com/r/khulnasoft/nagios-plugins/) then you will need to expose the socket within the container, like so:

```shell
$ docker run -v /var/run/docker.sock:/var/run/docker.sock khulnasoft/nagios-plugins check_docker_container_status.py -H unix:///var/run/docker.sock --container myContainer
 OK: Docker container 'myContainer' status = 'running', started at '2020-06-03T14:03:09.78303932Z' | query_time=0.0038s
```

See also DockerHub build status nagios plugin further down in the [CI section](https://github.com/KhulnaSoft/Nagios-Plugins#ci---continuous-integration--build-systems---git-jenkins-travis-ci--dockerhub-automated-builds).
...
- `check_kafka.py/.pl` - [Kafka](https://kafka.apache.org/) brokers API write & read back with configurable topics/partition and producer behaviour for acks, sleep, retries, backoff, can also lists topics and partitions. See [Kafka Scala Nagios Plugin](https://github.com/KhulnaSoft/Nagios-Plugin-Kafka) for a version with Kerberos support
- `check_redis_publish_subscribe.pl` - [Redis](https://redis.io/) publish-subscribe API write & read back with configurable subscriber wait. See other Redis checks under [NoSQL](https://github.com/KhulnaSoft/Nagios-Plugins#nosql)
...
See also [other 3rd Party Nagios Plugins](https://github.com/KhulnaSoft/Nagios-Plugins#more-3rd-party-nagios-plugins) you might be interested in.
...
Make sure to run the [automated build](https://github.com/KhulnaSoft/Nagios-Plugins#automated-build-from-source) or install the required Perl CPAN / Python PyPI modules first before calling `--help`.
...
HAProxy configurations are provided for all the major technologies under the [haproxy-configs/](https://github.com/KhulnaSoft/DevX/tree/master/HAProxy-configs) directory for many of the technologies tested in this project, including:
...
Strict validations include host/domain/FQDNs using TLDs which are populated from the official IANA list. This is done via the [Lib](https://github.com/KhulnaSoft/lib) and [PyLib](https://github.com/KhulnaSoft/pylib) submodules for Perl and Python plugins respectively - see those repos for details on configuring to permit custom TLDs like `.local` or `.intranet` (both already supported by default as they're quite common customizations).
...
- self-timeouts
- [Metrics Graphing integrations](https://github.com/KhulnaSoft/Nagios-Plugins#metrics-graphing-integrations)  - [Graphite](https://graphiteapp.org/), [InfluxDB](https://www.influxdata.com/), [OpenTSDB](http://opentsdb.net/) and [PNP4Nagios](https://docs.pnp4nagios.org/) can all auto-graph the perfdata from these plugins
- [Continuous Integration](https://travis-ci.org/KhulnaSoft/nagios-plugins) with tests for success and failure scenarios:
  - unit tests for the custom supporting [perl](https://github.com/KhulnaSoft/lib) and [python](https://github.com/KhulnaSoft/pylib) libraries
  - integration tests of the top level programs using the libraries for things like option parsing
  - [functional tests](https://github.com/KhulnaSoft/Nagios-Plugins/tree/master/tests) for the top level programs using [Docker containers](https://hub.docker.com/u/khulnasoft/) for each technology (eg. Cassandra, Elasticsearch, Hadoop, HBase, ZooKeeper, Memcached, Neo4j, MongoDB, MySQL, Riak, Redis...)
...
Patches are accepted in the form of [Github pull requests](https://github.com/KhulnaSoft/Nagios-Plugins/pulls), for which you will receive attribution automatically as Github tracks these merges.

### Support for Updates / Bugs Fixes / Feature Requests

Please raise a [Github Issue ticket](https://github.com/KhulnaSoft/Nagios-Plugins/issues) for if you need updates, bug fixes or new features. [Github pull requests](https://github.com/KhulnaSoft/Nagios-Plugins/pulls) are more than welcome.
...
Please make sure you have run `make update` first to pull the latest updates including library sub-modules and build the latest CPAN / PyPI module dependencies, (see [Quick Setup](https://github.com/KhulnaSoft/Nagios-Plugins#quick-setup) above).

Make sure you run the code by hand on the command line with `-v -v -v` for additional debug output and paste the full output in to the issue ticket. If you want to anonymize your hostnames/IP addresses etc you may use the `scrub.pl` tool found in my [DevOps Perl Tools repo](https://github.com/KhulnaSoft/DevOps-Perl-tools).
...
Some plugins like `check_yum.py` can be copied around independently but most newer more sophisticated plugins require the co-located libraries I've written so you should `git clone && make` on each machine you deploy this code to or just use the pre-built [Docker image](https://hub.docker.com/r/khulnasoft/nagios-plugins) which has all plugins and dependencies inside.
...
` make ` builds will install yum rpms / apt debs dependencies automatically as well as a load of Perl CPAN & Python PyPI libraries. To pick and choose what to install follow the [Manual Build](https://github.com/KhulnaSoft/Nagios-Plugins#manual-build) section instead
...
For Mac OS X see the [Mac OS X](https://github.com/KhulnaSoft/Nagios-Plugins#mac-os-x) section from Automated Build instructions.

#### Perl CPAN Modules

If installing the Perl CPAN or Python PyPI modules via your package manager or by hand instead of via the [Automated Build From Source](https://github.com/KhulnaSoft/Nagios-Plugins#automated-build-from-source) section, then read the [requirements.txt](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/requirements.txt) and [setup/cpan-requirements.txt](https://github.com/KhulnaSoft/Nagios-Plugins/blob/master/setup/cpan-requirements.txt) files for the lists of Python PyPI and Perl CPAN modules respectively that you need to install.
...
[Continuous Integration](https://travis-ci.org/KhulnaSoft/nagios-plugins) is run on this repo with tests for success and failure scenarios:

- Unit Tests - 1200+ unit tests covering the [Perl library](https://github.com/KhulnaSoft/lib) and [Python library](https://githu.com/khulnasoft/pylib)
...
- Functional Tests - 800+ full functional [tests/](https://github.com/KhulnaSoft/Nagios-Plugins/tree/master/tests) using dozens of [Docker Images](https://hub.docker.com/u/khulnasoft/) for full API testing of the various technologies
...
You can find the location using `perl_find_library_path.pl NetAddr::IP::InetBase` or `perl_find_library_path.sh NetAddr::IP::InetBase` from the [DevOps Perl Tools](https://github.com/KhulnaSoft/DevOps-Perl-tools) and [DevOps Bash Tools](https://github.com/KhulnaSoft/DevOps-Bash-tools) repos.
...
The above list of [enterprise monitoring systems](https://github.com/KhulnaSoft/Nagios-Plugins#enterprise-monitoring-systems) documents each one's integration capabilities with links to their documentation.
...
[![Star History Chart](https://api.star-history.com/svg?repos=KhulnaSoft/Nagios-Plugins&type=Date)](https://star-history.com/#KhulnaSoft/Nagios-Plugins&Date)
