...
try:
    ...
    from khulnasoft.utils import log, validate_chars, validate_int, isInt, \
...
class CheckDockerhubRepoBuildStatus(NagiosPlugin):
    ...
    def add_options(self):
        self.add_opt('-r', '--repo',
                     help="DockerHub repository to check, in form of '<user>/<repo>' eg. khulnasoft/pytools")
    ...
    def process_options(self):
        ...
        if self.tag is not None:
            ...
            #
            #   https://github.com/KhulnaSoft/Nagios-Plugins/issues
            #
