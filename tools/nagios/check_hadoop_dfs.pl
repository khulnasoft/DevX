...
- checks % HDFS space used. Based off an earlier plugin I wrote in 2010 that we used in production for over 2 years. This heavily leverages KhulnaSoftUtils so code in this file is very short but still much tighter validated
