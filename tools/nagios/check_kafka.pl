...
my $content = "This is a producer-consumer test message from KhulnaSoft:$progname:" . hostname . " at epoch $epoch ($tstamp) with random token: $random_string";
...
#    }
    ...
    $producer = Kafka::Producer->new(
                                      ...
                                      'ClientId'      => "KhulnaSoft Ltd $progname version $main::VERSION",
