...
- back tested against all Facebook Presto releases 0.69, 0.71 - 0.189
  (see Presto docker images on DockerHub at https://hub.docker.com/u/khulnasoft)
...
try:
    ...
    from khulnasoft.utils import log, ERRORS, UnknownError, support_msg_api, isList, validate_regex, validate_int
