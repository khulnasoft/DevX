...
my $channel  = "KhulnaSoft:$progname:$host:$epoch:" . substr($random_string, 0, 10);
my $message  = "This is a publish-subscribe test message from " . hostname . ":KhulnaSoft:$progname to $host at epoch $epoch with random token: $random_string";
