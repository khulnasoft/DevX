...
try:
    ...
    from khulnasoft.utils import UnknownError
    from khulnasoft.utils import validate_chars, jsonpp
    from khulnasoft.utils import isInt, qquit, plural, support_msg_api
...
class CheckTravisCILastBuild(NagiosPlugin):
    ...
    def add_options(self):
        self.add_opt('-r', '--repo', default=os.getenv('TRAVIS_REPO'),
                     help="Travis repo ($TRAVIS_REPO, 'user/repo' eg. 'KhulnaSoft/nagios-plugins'" + \
