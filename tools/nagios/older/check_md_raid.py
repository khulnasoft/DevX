...
def test_raid(verbosity):
    ...
    for array in raid_devices:
        ...
        # https://github.com/KhulnaSoft/Nagios-Plugins/blob/cd686831d4d730bc58165339a7547602e6619f87/legacy/check_md_raid.py#L105
        # active - Presumably, from
        # https://github.com/KhulnaSoft/Nagios-Plugins/blob/803b8de921c5254625f26a7107f82d9ba5279551/legacy/check_md_raid.py#L106
        state = "unknown"
        for line in detailed_output:
            if "State :" in line:
