...
#run ./check_dockerhub_repo_build_status.py -r khulnasoft/zookeeper
echo "DockerHub has space failures all the time, must allow for broken build:"
run_fail "0 2" ./check_dockerhub_repo_build_status.py -r khulnasoft/zookeeper

echo "testing repo with extended output information:"
#run ./check_dockerhub_repo_build_status.py -r khulnasoft/zookeeper -v
run_fail "0 2" ./check_dockerhub_repo_build_status.py -r khulnasoft/zookeeper -v

echo "testing detection of failing repo build:"
# intentionally broken repo created specifically for this test
run_fail 2 ./check_dockerhub_repo_build_status.py -r khulnasoft/ci_intentionally_broken_test_do_not_use -v
