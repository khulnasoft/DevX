...
There is also a newer Python version with more redactions and features such as --hash-hostnames available at https://github.com/KhulnaSoft/DevOps-Python-tools
";
